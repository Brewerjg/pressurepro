...
> = {
  open: {
    container: "tp-card bg-green-50 border-green-100",
    eyebrow: "text-green-700",
    headline: "text-green-900",
    sub: "text-green-700/80",
    iconWrap: "bg-green-700/10",
  ...
  closing: {
    container: "tp-card bg-bronze-100 border-bronze-100",
    eyebrow: "text-bronze-600",
    headline: "text-bronze-700",
    sub: "text-bronze-700/80",
    iconWrap: "bg-bronze-500/15",
  ...
  too_early: {
    ...
    cta: "bg-ink-100 text-ink-700 hover:bg-ink-200",
    Icon: Sprout,
    chartTone: null,
  },
  missed: {
