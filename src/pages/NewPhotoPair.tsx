      ...
      <section className="mx-4 space-y-3">
        ...
        <div className="tp-card p-4 space-y-2">
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-3 py-2 rounded-xl border-[1.5px] border-neutral-200 bg-card text-sm font-medium outline-none focus:border-brand-800 transition-colors resize-none"
          />
        ...
        <div className="flex gap-2">
          <Link
            to="/photos"
            className="flex-1 h-12 rounded-[14px] bg-neutral-100 text-neutral-700 font-bold text-sm flex items-center justify-center"
          >
            Cancel
          </Link>
          <button
            ...
            disabled={!canSave}
            className="flex-[2] h-12 rounded-[14px] bg-accent-500 text-white font-bold text-sm shadow-accent hover:bg-accent-600 disabled:opacity-50 disabled:shadow-none inline-flex items-center justify-center gap-2 transition-colors"
          >
